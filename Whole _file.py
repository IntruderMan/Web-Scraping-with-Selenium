...
while True:
    ...
    # driver.find_element(By.ID, "pnnext").click()
    # page = driver.find_element(By.ID, "pnnext")
    # if not page:
        # break
...
# phone = driver.find_element(By.XPATH,"/html/body/div[6]/div/div[9]/div[2]/div/div[2]/async-local-kp/div/div/div[1]/div/div/block-component/div/div[1]/div/div/div/div[1]/div/div/div[9]/div/div/span[2]/span/a/span/span").text
# print(phone)
...
'''For convert into series'''
# Names = pd.Series(Names)   
# Addresss = pd.Series(Addresss)   
# Phone = pd.Series(Phone)   
...
#For only create last points
# df=pd.DataFrame({'Title':Names,'Address':Addresss,'Phone Number':Phone})
# df.to_csv('task4.csv', encoding = 'utf-8-sig') 
